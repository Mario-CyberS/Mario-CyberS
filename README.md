...
Cybersecurity enthusiast with hands-on experience in SIEM deployment/configuration, scripting, and network hardening. I spent a year as a Cybersecurity Analyst at Diverse Computing, Inc., where I deployed and tuned Wazuh SIEM servers, automated ASA firewall backups using Python/Bash scripts, and worked with tools like Zabbix for monitoring and alerting.
